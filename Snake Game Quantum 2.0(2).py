...
class TkinkerCanvas:
    ...
    def __init__(self, top):
        ...
        self.snake1 = Snake(1, self.canvas, 'cyan')
        self.snake2 = Snake(2, self.canvas, 'lime')
    ...
    def make_canvas(self, width, height, title):
        ...
        canvas = tkinter.Canvas(self.top, width=width + 1, height=height + 1, bg='ivory')
